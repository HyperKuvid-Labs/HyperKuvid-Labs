...
function loadPersonalData(filePath: string): string {
  try {
...
function buildPrompt(data: string, userQuery: string): string {
...
rl.question("Ask me anything about me (cap: That I know): ", async (userInput) => {
